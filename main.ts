...
// This is one of the Method to make Object first define type than assign
...
// The difference is after adding type  you can use in multiple time dont need to define specific type again
...
// Nested Object and make function in object
...
function findSomething(paragraph:string, input:string){
    return
